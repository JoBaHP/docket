...
import { RefocusDirective } from "./refocus.directive";

// first overwrite the subcomponent of the tested component so the test does not go deep
@Component({
  template: '<input appRefocus type="text" value="test" />',
  selector: "app-dummy"
})
...
describe("Address Autocomplete Directive", () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [FocusDirectiveContainerComponent, RefocusDirective]
    }).compileComponents();
  }));
